...
class Ui_Deposit {
 public:
  ...
  void setupUi(QWidget *Deposit) {
    ...
    dateEdit_elim->setDateTime(QDateTime(QDate(2024, 1, 1), QTime(0, 0, 0)));
    dateEdit_elim->setMaximumDateTime(
        QDateTime(QDate(9999, 1, 1), QTime(20, 59, 59)));
    dateEdit_elim->setMinimumDate(QDate(2024, 1, 1));
    ...
    dateEdit_supp->setDateTime(QDateTime(QDate(2024, 1, 1), QTime(0, 0, 0)));
    dateEdit_supp->setMinimumDateTime(
        QDateTime(QDate(2024, 1, 1), QTime(0, 0, 0)));
    dateEdit_supp->setMinimumDate(QDate(2024, 1, 1));

    gridLayout->addWidget(dateEdit_supp, 2, 2, 1, 1);

    comboBox_supp = new QComboBox(Deposit);
    comboBox_supp->addItem(QString());
    comboBox_supp->addItem(QString());
    comboBox_supp->addItem(QString());
    comboBox_supp->addItem(QString());
  ...
  void retranslateUi(QWidget *Deposit) {
    Deposit->setWindowTitle(
        QCoreApplication::translate("Deposit", "Form", nullptr));
    label_3->setText(QCoreApplication::translate("Deposit", "Rate", nullptr));
    comboBox_frequency->setItemText(
        0, QCoreApplication::translate("Deposit", "every day", nullptr));
    comboBox_frequency->setItemText(
        1, QCoreApplication::translate("Deposit", "every month", nullptr));
    comboBox_frequency->setItemText(
        2, QCoreApplication::translate("Deposit", "every quater", nullptr));
    comboBox_frequency->setItemText(
        3, QCoreApplication::translate("Deposit", "every year", nullptr));

    label->setText(
        QCoreApplication::translate("Deposit", "Timeframe", nullptr));
    label_5->setText(
        QCoreApplication::translate("Deposit", "Frequency", nullptr));
    label_2->setText(QCoreApplication::translate("Deposit", "Amount", nullptr));
    comboBox_timeframe->setItemText(
        0, QCoreApplication::translate("Deposit", "1 month", nullptr));
    comboBox_timeframe->setItemText(
        1, QCoreApplication::translate("Deposit", "3 month", nullptr));
    comboBox_timeframe->setItemText(
        2, QCoreApplication::translate("Deposit", "6 month", nullptr));
    comboBox_timeframe->setItemText(
        3, QCoreApplication::translate("Deposit", "9 month", nullptr));
    comboBox_timeframe->setItemText(
        4, QCoreApplication::translate("Deposit", "1 year", nullptr));
    comboBox_timeframe->setItemText(
        5, QCoreApplication::translate("Deposit", "2 year", nullptr));
    comboBox_timeframe->setItemText(
        6, QCoreApplication::translate("Deposit", "3 year", nullptr));
    comboBox_timeframe->setItemText(
        7, QCoreApplication::translate("Deposit", "4 year", nullptr));
    comboBox_timeframe->setItemText(
        8, QCoreApplication::translate("Deposit", "5 year", nullptr));
    comboBox_timeframe->setItemText(
        9, QCoreApplication::translate("Deposit", "10 year", nullptr));
    comboBox_timeframe->setItemText(
        10, QCoreApplication::translate("Deposit", "20 year", nullptr));

    label_4->setText(
        QCoreApplication::translate("Deposit", "Tax Rate", nullptr));
    comboBox_supp->setItemText(
        0, QCoreApplication::translate("Deposit", "one-time", nullptr));
    comboBox_supp->setItemText(
        1, QCoreApplication::translate("Deposit", "once a month", nullptr));
    comboBox_supp->setItemText(
        2, QCoreApplication::translate("Deposit", "once a quater", nullptr));
    comboBox_supp->setItemText(
        3, QCoreApplication::translate("Deposit", "once a year", nullptr));

    checkBox_supplementions->setText(
        QCoreApplication::translate("Deposit", "Supplementions", nullptr));
    checkBox_eliminations->setText(
        QCoreApplication::translate("Deposit", "Eliminations", nullptr));
    checkBox_capitalization->setText(
        QCoreApplication::translate("Deposit", "Capitalization", nullptr));
    comboBox_elim->setItemText(
        0, QCoreApplication::translate("Deposit", "one-time", nullptr));
    comboBox_elim->setItemText(
        1, QCoreApplication::translate("Deposit", "once a month", nullptr));
    comboBox_elim->setItemText(
    ...
    label_6->setText(
        QCoreApplication::translate("Deposit", "Accured interest", nullptr));
