...
Calc::Calc(QWidget *parent) : QMainWindow(parent), ui(new Ui::Calc) {
  ui->setupUi(this);
  ui->label_equation->setText("tan(x)");
...
void Calc::on_pushButton_draw_graph_clicked() {
  controller.updateGraph(
      ui->widget_graph, ui->label_equation, ui->doubleSpinBox_x_max->value(),
      ui->doubleSpinBox_x_min->value(), ui->doubleSpinBox_y_max->value(),
      ui->doubleSpinBox_y_min->value());
}

void Calc::on_pushButton_equal_sign_clicked() {
  controller.upadteViewModel(ui->label_equation, ui->label_equation->text(),
                             ui->doubleSpinBox_x->value(), ui->checkBox_x);
}
...
void Calc::on_pushButton_credit_clicked() { ui_credit.show(); }

void Calc::on_pushButton_Deposit_clicked() { ui_deposit.show(); }
