...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_bracket_open = new QPushButton(functions);
        pushButton_bracket_open->setObjectName(QString::fromUtf8("pushButton_bracket_open"));
        pushButton_bracket_open->setGeometry(QRect(80, 280, 40, 50));
        ...
        pushButton_graph->setGeometry(QRect(80, 320, 80, 40));
        ...
        pushButton_bracket_close->setGeometry(QRect(120, 280, 40, 50));
